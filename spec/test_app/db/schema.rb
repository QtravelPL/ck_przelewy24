...
ActiveRecord::Schema.define(version: 20170329080714) do
  ...
  create_table "p24_confirmed_transactions", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["p24_session_id"], name: "index_p24_confirmed_transactions_on_p24_session_id"
  end
  ...
  create_table "p24_transactions", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["p24_session_id"], name: "index_p24_transactions_on_p24_session_id", unique: true
    t.index ["p24_sign"], name: "index_p24_transactions_on_p24_sign", unique: true
  end
